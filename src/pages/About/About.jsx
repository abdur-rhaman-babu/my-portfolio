    ...
    <div className="md:flex items-center gap-5 justify-between md:flex-row">
      ...
      <div className="flex flex-col gap-2 max-w-2xl">
        ...
        <div className="flex flex-col gap-3">
          <p className="font-bold text-xl"> My Journey as a Frontend Web Developer </p> 
          <p>
            <span className="font-bold">I am Abdur Rahman Babu,</span> a passionate frontend developer. I build
            interactive and user-friendly websites using HTML, CSS, JavaScript,
            Tailwind CSS, and other technologies. My programming journey began
            in March 2023, and I have been learning and improving ever since. I
            ...
            knowledge of modern frontend technologies. These courses have helped
            me understand how to create dynamic and responsive websites.
          </p>
          <p> Besides
            coding, I love playing cricket and football, which keep me active
            and refreshed. My goal is to keep learning, enhance my
            problem-solving skills, and build amazing web projects. I am excited
            about my journey in web development and look forward to growing as a
